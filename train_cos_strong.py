...
from data import BirdDataset, train_transform, test_transform, strong_transform
import os
...
# Load the dataset
train_data = BirdDataset(root_dir="dataset/CUB_200_2011/images", mode="train", transform=strong_transform)
...
optimizer = optimizer = torch.optim.Adam(model.parameters(), lr=0.001, weight_decay=1e-4, betas=(0.9, 0.999))
scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, T_max=epochs, eta_min=0.0001)

#tensorboard
store_path = 'runs/cos_strong'
